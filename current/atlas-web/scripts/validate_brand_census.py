...
db=sqlite3.connect(ROOT/'data'/'atlas.sqlite'); canonical={r[0].casefold() for r in db.execute("select canonical_name from entity where entity_type='brand'")};db.close()
