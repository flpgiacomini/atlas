...
def main():
 ...
 for row in rows:
  ...
  checks={
   ...
   'not_unresolved_duplicate':row['decision']=='published' or row['candidate_name'].casefold() not in canonical,
  }
  ...
  records.append({
   ...
   'validation_policy':'Relevância validada; fonte institucional individual e quatro relações evidenciadas são obrigatórias antes da publicação.',
  })
