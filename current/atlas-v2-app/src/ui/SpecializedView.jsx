...
function BrandRiver({ items, milestones, relations, year }) {
  ...
  return <section className="projection brand-river" aria-labelledby="brand-river-title">
    <header><p>RIO GENEALÓGICO</p><h2 id="brand-river-title">Marcas conhecidas até {year}</h2><span>{items.length} marcas publicadas · {lifecycle.length} marcos documentados · exibindo {visibleLifecycle.length} recentes · {undocumentedCount} sem marco</span></header>
